...
class ErrorHandler
{
    ...
    public function __construct()
    {
        ...
        set_exception_handler([$this, 'exceptionHandler']); // Обрабатываем исключения
        set_error_handler([$this, 'errorHandler']); // Ошибки
        ob_start(); // не выводим ошибку
        register_shutdown_function([$this, 'fatalErrorHandler']); // фатальные ошибки
    }
